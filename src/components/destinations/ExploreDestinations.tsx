...
const POPULAR_CAROUSEL_DATA = [
  ...
  { id: "kakinada", name: "Kakinada", state: "AP", lat: 16.9891, lng: 82.2475, img: "https://images.unsplash.com/photo-1540959733332-eab4deceeaf7?auto=format&fit=crop&w=400&q=80" },
  { id: "warangal", name: "Warangal", state: "Telangana", lat: 17.9689, lng: 79.5941, img: "https://images.unsplash.com/photo-1608958416715-4ba81f6ebba4?auto=format&fit=crop&w=400&q=80" },
  ...
  { id: "araku", name: "Araku Valley", state: "AP", lat: 18.3273, lng: 82.8775, img: "https://images.unsplash.com/photo-1500627869374-13ad991b1116?auto=format&fit=crop&w=400&q=80" },
  { id: "srisailam", name: "Srisailam", state: "AP", lat: 16.0748, lng: 78.8681, img: "https://images.unsplash.com/photo-1626294400523-2895e3474a58?auto=format&fit=crop&w=400&q=80" },
